...
- **Иконки фона таба** — сознательно НЕ образы из клиента (не хотим тянуть чужие ассеты с вовхеда, а свои квадранты `TalentTab.BackgroundFile` ещё не извлечены, см. отложенную задачу выше). Сейчас — чистый CSS: радиальный градиент + сильный `inset box-shadow` (виньетка), без внешних картинок.
